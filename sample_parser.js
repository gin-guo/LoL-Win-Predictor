...
summoner_id = process.argv[2];
match_id = process.argv[3];
API_key = process.argv[4];
...
(async () => {
  ...
  try {
    ...
    main_player_summoner_id = summoner_id;
    ...
    for (const participant of participants) {
      ...
      if (participant_data.summoner_id == main_player_summoner_id) {
        ...
        await csv2.toDisk(`./sample_output.csv`, { append: true });
    ...
    await csv1.toDisk(`./sample_input.csv`, { append: true });
