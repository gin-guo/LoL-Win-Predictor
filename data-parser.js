...
const API_KEY = 'RGAPI-8fae7d14-2e49-48a5-b7bc-abd35cd0af02';
...
(async () => {
    ...
    let res = await axios.get(`${base_url}/lol/league/v4/entries/RANKED_SOLO_5x5/${tier}/${division}?page=${page}`);
    ...
    for (const player of players) {
        ...
        res = await axios.get(`${base_url}/lol/summoner/v4/summoners/${main_player_summoner_id}`);
        summoner_data = res.data;
        main_player_puuid = summoner_data.puuid;

        // Request matches of the player
        res = await axios.get(`${base_url2}/lol/match/v5/matches/by-puuid/${main_player_puuid}/ids?start=0&count=${MATCHES_PER_PLAYER}`);
        matches_ids = res.data;

        for (const match_id of matches_ids) {
            // Get match data
            res = await axios.get(`${base_url2}/lol/match/v5/matches/${match_id}`);
            match_data = res.data;
            ...
            for (const participant of participants) {
                ...
                res = await axios.get(`${base_url}/lol/league/v4/entries/by-summoner/${participant.summonerId}`);
                ...
                participant_data.miniseries_wins   = participant_summoner_data.miniseries?.wins ?? 0;
                participant_data.losses            = participant_summoner_data.losses;
                participant_data.miniseries_losses = participant_summoner_data.miniseries?.losses ?? 0;
            ...
            for (const participant_data of participants_data) {
                ...
                if(participant_data.summoner_id == main_player_summoner_id) {
                    ...
                    data.main_player_miniseries_losses   = participant_data.miniseries_losses;
                    ...
                    data.main_player_champion_experience = participant_data.champion_experience;
                    ...
                    data[`ally_${ally_count}_miniseries_wins`]     = participant_data.miniseries_wins;
                    data[`ally_${ally_count}_losses`]              = participant_data.losses;
                    data[`ally_${ally_count}_miniseries_losses`]   = participant_data.miniseries_losses;
                    data[`ally_${ally_count}_tier`]                = participant_data.tier;
                    data[`ally_${ally_count}_rank`]                = participant_data.rank;
                    data[`ally_${ally_count}_league_points`]       = participant_data.league_points;
                    data[`ally_${ally_count}_champion_level`]      = participant_data.champion_level;
                    data[`ally_${ally_count}_champion_experience`] = participant_data.champion_experience;
                    ...
                    data[`rival_${rival_count}_miniseries_wins`]     = participant_data.miniseries_wins;
                    data[`rival_${rival_count}_losses`]              = participant_data.losses;
                    data[`rival_${rival_count}_miniseries_losses`]   = participant_data.miniseries_losses;
                    data[`rival_${rival_count}_tier`]                = participant_data.tier;
                    data[`rival_${rival_count}_rank`]                = participant_data.rank;
                    data[`rival_${rival_count}_league_points`]       = participant_data.league_points;
                    data[`rival_${rival_count}_champion_level`]      = participant_data.champion_level;
                    data[`rival_${rival_count}_champion_experience`] = participant_data.champion_experience;
